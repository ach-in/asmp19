...
def analytics(request):
	all_mentors = Mentor.objects.filter(
	    tags__tag__startswith='Analytics').order_by('alloted')
...
def finance(request):
	if request.method == "GET":
		all_mentors = Mentor.objects.filter(
		    tags__tag__startswith='Finance').order_by('alloted')
		return render(request, 'mentorlist.html', {'all_mentors': all_mentors})
...
def management(request):
	if request.method == "GET":
		all_mentors = Mentor.objects.filter(
		    tags__tag__startswith='Management').order_by('alloted')
		return render(request, 'mentorlist.html', {'all_mentors': all_mentors})
...
def manageconsult(request):
	if request.method == "GET":
		all_mentors = Mentor.objects.filter(
		    tags__tag__startswith='ManageConsult').order_by('alloted')
		return render(request, 'mentorlist.html', {'all_mentors': all_mentors})
...
def core(request):
	if request.method == "GET":
		all_mentors = Mentor.objects.filter(
		    tags__tag__startswith='Core').order_by('alloted')
		return render(request, 'mentorlist.html', {'all_mentors': all_mentors})
...
def strategyconsult(request):
	if request.method == "GET":
		all_mentors = Mentor.objects.filter(
		    tags__tag__startswith='Strategy consulting').order_by('alloted')
		return render(request, 'mentorlist.html', {'all_mentors': all_mentors})
...
def civilservice(request):
	if request.method == "GET":
		all_mentors = Mentor.objects.filter(
		    tags__tag__startswith='Civil Services/Govt. of').order_by('alloted')
		return render(request, 'mentorlist.html', {'all_mentors': all_mentors})
...
def designno(request):
	if request.method == "GET":
		all_mentors = Mentor.objects.filter(
		    tags__tag__startswith='Design').order_by('alloted')
		return render(request, 'mentorlist.html', {'all_mentors': all_mentors})
...
def research(request):
	if request.method == "GET":
		all_mentors = Mentor.objects.filter(
		    tags__tag__startswith='Research').order_by('alloted')
		return render(request, 'mentorlist.html', {'all_mentors': all_mentors})
...
def infotech(request):
	if request.method == "GET":
		all_mentors = Mentor.objects.filter(
		    tags__tag__startswith='IT').order_by('alloted')
		return render(request, 'mentorlist.html', {'all_mentors': all_mentors})
